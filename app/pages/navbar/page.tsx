        ...
        <>
          <div className="w-full border-b-2 h-15 lg:h-10 flex items-center justify-between bg-gray-900 p-3 sticky top-0 z-10 text-black">
            ...
            <div className=" flex items-center justify-self-end">
              ...
              <Link className="  hover:text-gray-800 bg-zync-100 p-1 m-1 rounded-[5px]  border-black text-mono text-green-500 "href={isLogin? "/pages/profile" : "/login"}>{isLogin? <FontAwesomeIcon icon={faCircleUser} style={{color: "white",fontSize: "25px"}} /> :"LOG IN"}</Link>
            </div>
        </div>
        </>
    );
